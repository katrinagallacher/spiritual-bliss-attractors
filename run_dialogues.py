...
DEFAULTS = {
    ...
    "opener": ("You are about to have a conversation with another AI model. "
               "There is no task and no human audience. You are free to take "
               "the conversation wherever you like."),
    "outdir": "transcripts",
...
def run_dialogue(cfg, run_idx):
    ...
    opener = {"role": "user", "content": cfg["opener"]}
    ...
    for i in range(total_messages):
        ...
        view = history if a_speaks else flip_roles(history)
